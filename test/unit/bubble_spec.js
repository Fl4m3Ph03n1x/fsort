...
describe("bubble", () => {
    ...
    it("should sort an array of size 1 in DES order", () => {
        const array = [ 5 ];
        const expected = [ 5 ];
        const actual = bubble( DESC, array );
    ...
    it("should order an array in ascending order using a custom fnCompare", () => {
        ...
        const actual = bubble( fnCompare )( array );
